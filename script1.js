function rand(max) {
  ...
  // Call this function when the maze game finishes
  function endMazeGame(totalSteps) {
    console.log(`Maze game finished with ${totalSteps} steps`);
    
    // Send total steps to backend as the score
    sendScoreToBackend(totalSteps, "maze");
  }
